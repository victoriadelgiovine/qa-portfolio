...
**Descripción:** Al modificar la URL añadiendo /contactList, 
un usuario no autenticado accede a la lista de contactos.
...
**Justificación:** Compromete la seguridad del sistema al permitir 
...
**Descripción:** El sistema no distingue entre campo vacío 
...
**Descripción:** Mismo comportamiento que BUG-002 
...
**Descripción:** El sistema permite registrar un contacto 
con email ya existente sin mostrar mensaje de error.

**Pasos para reproducir:**
1. Add a New Contact
2. Completar campos con mail ya existente
3. Hacer click en Submit
...
**Resultado obtenido:** El sistema generó el contacto con @
...
**Descripción:** El sistema permite editar un contacto 
usando un email ya existente.

**Precondiciones:** Existen dos contactos, uno con 
mail test@test.com y otro con mail diferente.

**Pasos para reproducir:**
1. Seleccionar un contacto
2. Reemplazar mail por uno ya existente
3. Hacer click en Submit

**Resultado esperado:** Mensaje de error por mail duplicado  
**Resultado obtenido:** El sistema guardó el cambio con mail duplicado  
**Justificación:** Puede generar cruce de datos y pérdida 
de confiabilidad
